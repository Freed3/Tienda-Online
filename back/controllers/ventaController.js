...
const enviar_correo_compra_cliente = async function(req,res){
    ...
    var transporter = nodemailer.createTransport(smtpTransport({
        ...
        host: 'smtp.gmail.com',
        auth: {
        user: 'estebanromero171@gmail.com',
        pass: 'czxozeazjyjaznly'
        }
    }));
...
readHTMLFile(process.cwd() + '/mail.html', (err, html)=>{
    let rest_html = ejs.render(html, {data: data,cliente:cliente,_id:_id,fecha:fecha,precio:precio,cantidad:cantidad,subtotal:subtotal,precio_envio:precio_envio});

    var template = handlebars.compile(rest_html);
    var htmlToSend = template({op:true});

    var mailOptions = {
        from: 'estebanromero171@gmail.com',
