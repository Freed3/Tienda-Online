...
export class AdminService {
  ...
  public IsAuthenticand(allowRoles : string[]): boolean{
...
//KPI
kpi_ganacias_mensuales_admin(token:any):Observable<any>{
  let headers = new HttpHeaders({'Content-Type':'application/json','Authorization':token});
  return this._http.get(this.url+'kpi_ganacias_mensuales_admin',{headers:headers});
}
}
